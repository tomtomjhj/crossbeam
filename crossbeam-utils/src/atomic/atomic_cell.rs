...
#[cfg(all(has_atomic_u8, not(feature = "check-loom")))]
...
#[cfg(all(has_atomic_u16, not(feature = "check-loom")))]
...
#[cfg(all(has_atomic_u32, not(feature = "check-loom")))]
impl_arithmetic!(i32, atomic::AtomicI32, "let a = AtomicCell::new(7i32);");
#[cfg(has_atomic_u64)]
impl_arithmetic!(u64, atomic::AtomicU64, "let a = AtomicCell::new(7u64);");
#[cfg(all(has_atomic_u64, not(feature = "check-loom")))]
impl_arithmetic!(i64, atomic::AtomicI64, "let a = AtomicCell::new(7i64);");
#[cfg(all(has_atomic_u128, not(feature = "check-loom")))]
